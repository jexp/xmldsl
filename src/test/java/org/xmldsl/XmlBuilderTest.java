...
import static org.xmldsl.PERSON.*;
import org.xmldsl.builder.JdomXmlBuilder;
import org.xmldsl.builder.XmlEncBuilder;
import org.xmldsl.builder.XmlBuilder;
import org.xmldsl.builder.Tag;
...
public class XmlBuilderTest {
    ...
    private void checkComplexStructure(XmlBuilder xml) {
        final Tag<PERSON> person = xml.tag(PERSON.class).add().tags(
                xml.tag(CHILD.class).add().tags(
                        xml.tag(PERSON.class), xml.tag(PERSON.class),
                        xml.tag(PERSON.class).add().tags(
